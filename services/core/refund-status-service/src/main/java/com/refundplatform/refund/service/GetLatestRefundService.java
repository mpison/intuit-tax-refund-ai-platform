...
import com.refundplatform.refund.repository.*;

import org.springframework.stereotype.Service;
import org.springframework.transaction.annotation.Transactional;

@Service
public class GetLatestRefundService {
    private final UserRepository users;
    private final TaxReturnRepository returns;
    private final RefundStatusRepository statuses;

    public GetLatestRefundService(UserRepository users, TaxReturnRepository returns, RefundStatusRepository statuses) {
        this.users = users;
